...
(function($){
    ...
    $.fn.email_multiple = function(options) {
        ...
        {
            $(this).after("<input type=\"text\" data-role=\"tagsinput\" id=\"tagsmaill\" class=\"form-control enter-mail-id\" placeholder=\"Mail To\">");
            let $orig = $(this);
            ...
            $element.keydown(function (e) {
                ...
                if (e.keyCode === 13 || e.keyCode === 32) {
                    ...
                    if (/^[a-z0-9._-]+@[a-z0-9._-]+\.[a-z]{2,6}$/.test(getValue)){
                        $('#tagsmaill').append('<span class="email-ids">' + getValue + '<span class="cancel-email">x</span></span>');
                        $element.val('');
